...
using Zeroum.DeveloperEvaluation.ABP.Bruna.WebApi.Controllers;

namespace Zeroum.DeveloperEvaluation.ABP.Bruna.WebApi.Tests
{
    public class ClientesControllerTests
    {
        private Mock<IClientesRepository> _mockClientesRepository;
        ...
        public void Setup()
        {
            ...
            _controller = new ClientesController(null, _mockClientesRepository.Object);  // Passing null for ILogger
        }
        ...
        public async Task CreateOrEditClientPJ_ReturnsCreatedResult_WhenSuccess()
        {
            ...
            _mockClientesRepository.Setup(b => b.CreateOrEditClientPJAsync(It.IsAny<ClientesPJCreateRequest>())).ReturnsAsync(1); // Mock success
        ...
        public async Task CreateOrEditClientPJ_ReturnsBadRequest_WhenFail()
        {
            // Arrange
            var request = new ClientesPJCreateRequest(); // Fill with mock data
            _mockClientesRepository.Setup(b => b.CreateOrEditClientPJAsync(It.IsAny<ClientesPJCreateRequest>())).ReturnsAsync(0); // Mock failure
        ...
        public async Task GetAllClientsPF_ReturnsOkResult_WhenClientsFound()
        {
            ...
            _mockClientesRepository.Setup(b => b.GetAllClientsPFAsync()).ReturnsAsync(mockClientsPF); // Mock list with clients
        ...
        {
            // Arrange
            _mockClientesRepository.Setup(b => b.GetAllClientsPFAsync()).ReturnsAsync(new List<ClientesPFResponse>()); // Mock empty list
        ...
        public async Task GetAllClientsPJ_ReturnsOkResult_WhenClientsFound()
        {
            ...
            _mockClientesRepository.Setup(b => b.GetAllClientsPJAsync()).ReturnsAsync(mockClientsPJ); // Mock list with clients
        ...
        {
            // Arrange
            _mockClientesRepository.Setup(b => b.GetAllClientsPJAsync()).ReturnsAsync(new List<ClientesPJResponse>()); // Mock empty list
        ...
        {
            // Arrange
            _mockClientesRepository.Setup(b => b.DeleteClientPJAsync(It.IsAny<int>())).ReturnsAsync(true); // Mock success
        ...
        {
            // Arrange
            _mockClientesRepository.Setup(b => b.DeleteClientPJAsync(It.IsAny<int>())).ReturnsAsync(false); // Mock failure
